...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 1.0, "minX": 0.0, "maxY": 1.0, "series": [{"data": [[0.0, 1.0]], "isOverall": false, "label": "Requête TCP - Connexion", "isController": false}, {"data": [[0.0, 1.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 1", "isController": false}, {"data": [[0.0, 1.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 2", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.0, "maxY": 12.0, "series": [{"data": [[1.0, 12.0]], "isOverall": false, "label": "Requête TCP - Connexion", "isController": false}, {"data": [[1.0, 12.0]], "isOverall": false, "label": "Requête TCP - Connexion-Aggregated", "isController": false}, {"data": [[1.0, 2.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 1", "isController": false}, {"data": [[1.0, 2.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 1-Aggregated", "isController": false}, {"data": [[1.0, 1.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 2", "isController": false}, {"data": [[1.0, 1.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 2-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 1.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.77783108E12, "maxY": 12.0, "series": [{"data": [[1.77783108E12, 12.0]], "isOverall": false, "label": "Requête TCP - Connexion", "isController": false}, {"data": [[1.77783108E12, 2.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 1", "isController": false}, {"data": [[1.77783108E12, 1.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 2", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77783108E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.77783108E12, "maxY": 12.0, "series": [{"data": [[1.77783108E12, 12.0]], "isOverall": false, "label": "Requête TCP - Connexion", "isController": false}, {"data": [[1.77783108E12, 2.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 1", "isController": false}, {"data": [[1.77783108E12, 1.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 2", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77783108E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.77783108E12, "maxY": 10.0, "series": [{"data": [[1.77783108E12, 10.0]], "isOverall": false, "label": "Requête TCP - Connexion", "isController": false}, {"data": [[1.77783108E12, 1.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 1", "isController": false}, {"data": [[1.77783108E12, 0.0]], "isOverall": false, "label": "Requête TCP - Changement surnom 2", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77783108E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 1.5, "minX": 1.0, "maxY": 12.0, "series": [{"data": [[1.0, 12.0], [2.0, 1.5]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 2.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 1.5, "minX": 1.0, "maxY": 12.0, "series": [{"data": [[1.0, 12.0], [2.0, 1.5]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 2.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 0.05, "minX": 1.77783108E12, "maxY": 0.05, "series": [{"data": [[1.77783108E12, 0.05]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77783108E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 0.05, "minX": 1.77783108E12, "maxY": 0.05, "series": [{"data": [[1.77783108E12, 0.05]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77783108E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.016666666666666666, "minX": 1.77783108E12, "maxY": 0.016666666666666666, "series": [{"data": [[1.77783108E12, 0.016666666666666666]], "isOverall": false, "label": "Requête TCP - Connexion-success", "isController": false}, {"data": [[1.77783108E12, 0.016666666666666666]], "isOverall": false, "label": "Requête TCP - Changement surnom 1-success", "isController": false}, {"data": [[1.77783108E12, 0.016666666666666666]], "isOverall": false, "label": "Requête TCP - Changement surnom 2-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77783108E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 0.05, "minX": 1.77783108E12, "maxY": 0.05, "series": [{"data": [[1.77783108E12, 0.05]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77783108E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
